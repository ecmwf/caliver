...
values2mask <- raster::raster("/var/tmp/moc0/geff/clim_fuelmodel.nc_ggN256_shifted.nc")
rasterVis::levelplot(values2mask)
```
...
p <- rasterVis::levelplot(raster::mask(listOfMaps, values2mask), 
                          col.regions = rev(grDevices::heat.colors(20)),
                          colorkey = list(space = "right"), 
                          names.attr = ifiles)
# Define a background map
