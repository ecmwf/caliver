...
The European Forest Fire Information System provides a set of fire danger thresholds/classes harmonized across Europe (https://effis.jrc.ec.europa.eu/about-effis/technical-background/fire-danger-forecast/). For instance, the FWI ranges are (upper bound excluded):
  * Very low = 0 - 5.2
  * Low = 5.2 - 11.2
  * Moderate = 11.2 - 21.3
  * High = 21.3 - 38.0
