...
vignette: >
  %\VignetteIndexEntry{caliver-advanced}
...
BasisRegions <- SpatialPolygonsDataFrame(Sr = simplepolys[as.character(1:14)],
                                         data = df_gfed4)
saveRDS(object = BasisRegions, file = "BasisRegions_simplified.rds")
...
# FWI <- raster::brick("fwi_erai_1980_2016.nc")
```
