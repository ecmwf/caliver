...
```{r}
CanadaFRP <- plotOBSvsForecast(inDir = "GEFF1.2/forecast_fwi", 
...
```{r}
SpainFRP <- plotOBSvsForecast(inDir = "GEFF1.2/forecast_fwi", 
                              areaOfInterest = fireBBOX, 
...
```{r}
IndonesiaFRP <- plotOBSvsForecast(inDir = "GEFF1.2/forecast_fwi", 
                                  areaOfInterest = fireBBOX, 
...
```{r}
ChileFRP <- plotOBSvsForecast(inDir = "GEFF1.2/forecast_fwi", 
                              areaOfInterest = fireBBOX, 
...
For the fire in Canada, the peak in radiative power was obtained on the 2015-06-16.
...
# DAY 1
fwi <- caliver::maskcropsub(r = raster::raster("/scratch/mo/moc0/fire/GEFF1.2/forecast_fwi/20160516_20160516_ecfire_fwi_fwi.nc"), p = Canada, mask = TRUE, crop = FALSE)
fwi_v <- as.vector(fwi)
fwi_v[fwi_v < 9] <- FALSE
fwi_v[fwi_v >= 9] <- TRUE

frp <- caliver::maskcropsub(r = raster::brick("/scratch/mo/moc0/fire/events/CAMS_2016-05-01_2016-05-31_frpfire_rotated.nc"), p = Canada, mask = TRUE, crop = FALSE, i2subset = 16)

frp_resampled <- as.vector(raster::resample(x = frp, y = fwi, progress = 'text'))
...
# DAY 2
fwi <- caliver::maskcropsub(r = raster::raster("/scratch/mo/moc0/fire/GEFF1.2/forecast_fwi/20160516_20160517_ecfire_fwi_fwi.nc"), p = Canada, mask = TRUE, crop = FALSE)
fwi_v <- as.vector(fwi)
fwi_v[fwi_v < 9] <- FALSE
fwi_v[fwi_v >= 9] <- TRUE
A <- verify(obs = frp_resampled, pred = fwi_v, #baseline = climatology,
...
# DAY 3
fwi <- caliver::maskcropsub(r = raster::raster("/scratch/mo/moc0/fire/GEFF1.2/forecast_fwi/20160516_20160518_ecfire_fwi_fwi.nc"), p = Canada, mask = TRUE, crop = FALSE)
fwi_v <- as.vector(fwi)
fwi_v[fwi_v < 9] <- FALSE
fwi_v[fwi_v >= 9] <- TRUE
A <- verify(obs = frp_resampled, pred = fwi_v, #baseline = climatology,
...
# DAY 4
fwi <- caliver::maskcropsub(r = raster::raster("/scratch/mo/moc0/fire/GEFF1.2/forecast_fwi/20160516_20160519_ecfire_fwi_fwi.nc"), p = Canada, mask = TRUE, crop = FALSE)
fwi_v <- as.vector(fwi)
fwi_v[fwi_v < 9] <- FALSE
fwi_v[fwi_v >= 9] <- TRUE
A <- verify(obs = frp_resampled, pred = fwi_v, #baseline = climatology,
...
# DAY 5
fwi <- caliver::maskcropsub(r = raster::raster("/scratch/mo/moc0/fire/GEFF1.2/forecast_fwi/20160516_20160520_ecfire_fwi_fwi.nc"), p = Canada, mask = TRUE, crop = FALSE)
fwi_v <- as.vector(fwi)
fwi_v[fwi_v < 9] <- FALSE
fwi_v[fwi_v >= 9] <- TRUE
A <- verify(obs = frp_resampled, pred = fwi_v, #baseline = climatology,
...
# DAY 6
fwi <- caliver::maskcropsub(r = raster::raster("/scratch/mo/moc0/fire/GEFF1.2/forecast_fwi/20160516_20160521_ecfire_fwi_fwi.nc"), p = Canada, mask = TRUE, crop = FALSE)
fwi_v <- as.vector(fwi)
fwi_v[fwi_v < 9] <- FALSE
fwi_v[fwi_v >= 9] <- TRUE
A <- verify(obs = frp_resampled, pred = fwi_v, #baseline = climatology,
...
# DAY 7
fwi <- caliver::maskcropsub(r = raster::raster("/scratch/mo/moc0/fire/GEFF1.2/forecast_fwi/20160516_20160522_ecfire_fwi_fwi.nc"), p = Canada, mask = TRUE, crop = FALSE)
fwi_v <- as.vector(fwi)
fwi_v[fwi_v < 9] <- FALSE
fwi_v[fwi_v >= 9] <- TRUE
A <- verify(obs = frp_resampled, pred = fwi_v, #baseline = climatology,
...
# DAY 8
fwi <- caliver::maskcropsub(r = raster::raster("/scratch/mo/moc0/fire/GEFF1.2/forecast_fwi/20160516_20160523_ecfire_fwi_fwi.nc"), p = Canada, mask = TRUE, crop = FALSE)
fwi_v <- as.vector(fwi)
fwi_v[fwi_v < 9] <- FALSE
fwi_v[fwi_v >= 9] <- TRUE
A <- verify(obs = frp_resampled, pred = fwi_v, #baseline = climatology,
...
# DAY 9
fwi <- caliver::maskcropsub(r = raster::raster("/scratch/mo/moc0/fire/GEFF1.2/forecast_fwi/20160516_20160524_ecfire_fwi_fwi.nc"), p = Canada, mask = TRUE, crop = FALSE)
fwi_v <- as.vector(fwi)
fwi_v[fwi_v < 9] <- FALSE
fwi_v[fwi_v >= 9] <- TRUE
A <- verify(obs = frp_resampled, pred = fwi_v, #baseline = climatology,
...
# DAY 10
fwi <- caliver::maskcropsub(r = raster::raster("/scratch/mo/moc0/fire/GEFF1.2/forecast_fwi/20160516_20160525_ecfire_fwi_fwi.nc"), p = Canada, mask = TRUE, crop = FALSE)
fwi_v <- as.vector(fwi)
fwi_v[fwi_v < 9] <- FALSE
fwi_v[fwi_v >= 9] <- TRUE
A <- verify(obs = frp_resampled, pred = fwi_v, #baseline = climatology,
...
myTS <- data.frame("POD" = x, "Day" = seq(1, 10))

ggplot(myTS, aes(Day, POD)) + geom_point() + geom_line() +
