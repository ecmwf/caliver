...
test_that("maskcropsub works", {
  ...
  x1 <- maskcropsub(r, p, mask = TRUE, crop = TRUE)
  ...
  x2 <- maskcropsub(r, p, mask = TRUE, crop = FALSE)
  ...
  x3 <- maskcropsub(r, p, mask = FALSE, crop = FALSE)
  ...
  x4 <- maskcropsub(r, p, mask = FALSE, crop = TRUE)
  ...
  x5 <- maskcropsub(r, p, mask = TRUE, crop = TRUE, i2subset = 1:10)
