...
test_that("maskcrop works", {
  ...
  x1 <- maskcrop(r, p, mask = TRUE, crop = TRUE)
  ...
  x2 <- maskcrop(r, p, mask = TRUE, crop = FALSE)
  ...
  x3 <- maskcrop(r, p, mask = FALSE, crop = FALSE)
  ...
  x4 <- maskcrop(r, p, mask = FALSE, crop = TRUE)
